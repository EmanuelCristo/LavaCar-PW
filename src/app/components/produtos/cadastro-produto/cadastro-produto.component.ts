...
export class CadastroProdutoComponent implements OnInit {
  ...
  constructor(private produtoService: ProdutoService, private fornecedorService:
    FornecedorService, private route: ActivatedRoute, private router: Router) { }  async ngOnInit() {
  ...
  loadFornecedores() {
    this.fornecedorService.getAllFornecedores().then((fornecedores: Fornecedor[]) => {
